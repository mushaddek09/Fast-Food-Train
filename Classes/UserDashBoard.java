...
public class UserDashBoard {
    ...
    UserDashBoard(String textField1) {
        ...
        label2 = new JLabel("Welcome to our Fast Food Train");
        ...
        label4 = new JLabel("Select which catagory food");
        ...
        b4 = new JButton();
        b4.setIcon(new ImageIcon("image/singara.png"));
        b4.setBounds(60, 460, 300, 220);
        b4.setCursor(new Cursor(Cursor.HAND_CURSOR));
        // b4.setContentAreaFilled(false);
        // b4.setBorderPainted(false);
        l1 = new JButton("Singara");
        ...
        b5 = new JButton();
        b5.setIcon(new ImageIcon("image/samocha.jpg"));
        b5.setBounds(380, 460, 300, 220);
        b5.setCursor(new Cursor(Cursor.HAND_CURSOR));
        // b5.setContentAreaFilled(false);
        // b5.setBorderPainted(false);
        l2 = new JButton("Samocha");
        ...
        b8 = new JButton();
        b8.setIcon(new ImageIcon("image/offer.png"));
